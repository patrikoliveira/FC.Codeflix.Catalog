...
public class CategoryTest
{
    ...
    [Fact(DisplayName = nameof(InstantiateErrorWhenNameIsGreateerThan255Characters))]
    [Trait("Domain", "Category - Aggregates")]
    public void InstantiateErrorWhenNameIsGreateerThan255Characters()
    {
        var validCategory = _categoryTestFixture.GetValidCategory();
    ...
    [Fact(DisplayName = nameof(InstantiateErrorWhenDescriptionIsGreateerThan10_000Characters))]
    [Trait("Domain", "Category - Aggregates")]
    public void InstantiateErrorWhenDescriptionIsGreateerThan10_000Characters()
    {
        var validCategory = _categoryTestFixture.GetValidCategory();
    ...
    [Fact(DisplayName = nameof(UpdateErrorWhenNameIsGreateerThan255Characters))]
    [Trait("Domain", "Category - Aggregates")]
    public void UpdateErrorWhenNameIsGreateerThan255Characters()
    {
        var category = _categoryTestFixture.GetValidCategory();
    ...
    [Fact(DisplayName = nameof(InstantiateErrorWhenDescriptionIsGreateerThan10_000Characters))]
    [Trait("Domain", "Category - Aggregates")]
    public void UpdateErrorWhenDescriptionIsGreateerThan10_000Characters()
    {
        var category = _categoryTestFixture.GetValidCategory();
        ...
        Action action = () => new DomainEntity.Category("Category new Name", invalidDescription);
